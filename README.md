...
A small library providing integration between the [React Router](https://reactrouter.com/) framework (formerly [Remix](https://v2.remix.run/)) and the [Relay](https://relay.dev/) GraphQL client, enabling streaming with the `@defer` directive.
